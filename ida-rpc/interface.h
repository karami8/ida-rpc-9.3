...
const char* website_url = "https://github.com/karami8/ida-rpc-9.3";

int idaapi open_link( int, form_actions_t& ) {
...
{	
	...
	(                     // add macros for the checkboxes and other fields etc. later
		...
		"<#Address to be displayed beside function name#Address type:" DROPDOWN_FIELD( 1 ) ":0::::>\n"
		"<#Type of info printed to output window#Output type :" DROPDOWN_FIELD( 2 ) ":0::::>\n"
		...
		"IDA RPC 9.3 by Karami\n"
		"<#Homepage#https://www.github.com/karami8/ida-rpc-ida9.3:k::::::>\n\n",
